...
Accuracy of Random Forests and Boosting methods seems to be very good and the ensembling method with majority voting may replace Random Forests in case it does not agree with majority vote.
```{r ensembling}
predCombs <-predRFs
...
```
 ...
 Though the accuracy of Combined model (Model Ensembling) seems to be similar to that of Random Forests(0.98), it is expected to be a superior method for new data.
